...
<div class="card">
    <div class="card-body"> 
                ...
                <form action="{{route('employee.update',$employee->id)}}" class="was-validated" method="POST" onsubmit="return confirm('Are you sure you want to edit this employee?');">
                @method('PUT')
                    @csrf
                    ...
                    <a href="{{route('employee.index')}}" class="btn btn-secondary btn-xs float-end py-0 ">Back to Employee list</a>    
                </form>
            </div>
        </div>
    </div>
