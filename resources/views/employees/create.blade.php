...
<div class="form-group has-validation">
    ...
    @endif
            ...
            <div class="form-group has-validation">
                ...
                <input type="checkbox" name="is_active" id="is_active" class="{{$errors->has('is_active') ? 'is-invalid' : ''}}" value="1" {{ old('is_active') == '1' ? 'checked' : '' }}> <!--so here we can use the ternary operator-->
